...
<!--         <link rel="icon" type="image/x-icon" href="assets/img/favicon.ico" /> -->
		...
		<link rel="stylesheet" href="${path }/resources/css/bootstrap_styles.css" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
...
<!--                 <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="assets/img/navbar-logo.svg" /></a><button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu<i class="fas fa-bars ml-1"></i></button> -->
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">Study</a></li>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase"  data-toggle="modal" href="#loginModal">Tell Me More</a>
            </div>
        </header>
        <!-- Services-->
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Langueges</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x"><i class="fas fa-circle fa-stack-2x text-primary"></i><i class="fab fa-leanpub fa-stack-1x fa-inverse"></i></span>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading text-muted">Albarang</div>
                            </div>
                        </div>
                    </div>
                        <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                ...
                                <div class="portfolio-caption-subheading text-muted">HaxaDirect</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <input class="form-control" id="ID" type="text" placeholder="Your ID *" required="required" data-validation-required-message="Please enter your ID." />
                                    <br>
                                    <input class="form-control" id="PW" type="password" placeholder="Your PW *" required="required" data-validation-required-message="Please enter your PW." />
                                    <hr>
